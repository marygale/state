<html>
<head>
    <title>State.org - @yield('title')</title>
    <link href="{!! asset('css/bootstrap.min.css') !!}" media="screen,projection" rel="stylesheet" type="text/css" />
    <link href="{!! asset('css/font-awesome.min.css') !!}" media="screen,projection" rel="stylesheet" type="text/css" />
    <link href="{!! asset('css/smartadmin-production.css') !!}" media="screen,projection" rel="stylesheet" type="text/css" />
</head>
<body class="">
<!-- HEADER -->
<header id="header">
